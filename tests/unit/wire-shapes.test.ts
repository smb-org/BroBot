  ...
  it("freezes keys, values, and Durable Object keys", async () => {
    ...
    try {
      ...
      expect(shapeKeys(wireShapes)).toEqual([
        ...
        "$.panel.channelOverview: activeModules,bot,botPermissions,broadcasterConnection,broadcasterPermissions,channelBotConsent,channelId,chatSubscription,controls,displayName,language,lastError,login,moderator,role,streamStartedAt,streamState,tokens",
        ...
        "$.panel.channelOverview.controls: mute,pause",
        "$.panel.channelOverview.controls.mute: active,mode,until",
        "$.panel.channelOverview.controls.pause: active,mode,until",
        ...
        "$.panel.channelsResponse.channels[]: bot,botPermissions,broadcasterConnection,broadcasterPermissions,channelBotConsent,channelId,chatSubscription,controls,displayName,language,lastError,login,moderator,role,streamStartedAt,streamState,tokens",
        ...
        "$.panel.channelsResponse.channels[].controls: mute,pause",
        "$.panel.channelsResponse.channels[].controls.mute: active,mode,until",
        "$.panel.channelsResponse.channels[].controls.pause: active,mode,until",
        ...
        "$.panel.channelState: bot,botPermissions,broadcasterConnection,broadcasterPermissions,channelBotConsent,channelId,chatSubscription,controls,displayName,language,lastError,login,moderator,role,streamStartedAt,streamState,tokens",
        ...
        "$.panel.channelState.controls: mute,pause",
        "$.panel.channelState.controls.mute: active,mode,until",
        "$.panel.channelState.controls.pause: active,mode,until",
        ...
        "$.panel.eventFilters: module,origin,person,tone,tones",
