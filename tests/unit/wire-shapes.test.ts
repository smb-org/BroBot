  ...
  it("freezes keys, values, and Durable Object keys", async () => {
    ...
    try {
      ...
      expect(shapeKeys(wireShapes)).toEqual([
        ...
        "$.panel.channelOverview: activeModules,bot,botPermissions,broadcasterConnection,broadcasterPermissions,channelBotConsent,channelId,chatSubscription,controls,displayName,lastError,login,moderator,role,streamStartedAt,streamState,tokens",
        ...
        "$.panel.channelsResponse.channels[]: bot,botPermissions,broadcasterConnection,broadcasterPermissions,channelBotConsent,channelId,chatSubscription,controls,displayName,lastError,login,moderator,role,streamStartedAt,streamState,tokens",
        ...
        "$.panel.channelState: bot,botPermissions,broadcasterConnection,broadcasterPermissions,channelBotConsent,channelId,chatSubscription,controls,displayName,lastError,login,moderator,role,streamStartedAt,streamState,tokens",
