...
const overlayObsInstructionsCatalog: LocaleCatalog<OverlayObsInstructionsTexts> = {
  de: {
    ...
    refreshWhenActive: "„Browserquelle aktualisieren, wenn Szene aktiv wird“ ausgeschaltet lassen.",
    shutdownWhenHidden: "„Quelle schließen, wenn nicht sichtbar“ ausgeschaltet lassen.",
