      ...
      >
        ...
        {!showChannelNotReleased && route.kind === "channel" && route.section === "overlays" && selectedChannel !== null
          ? route.editorOverlayId === undefined
            ...
            : <OverlayEditorPage key={dashboardRoutePath(route)} channelId={route.channelId} overlayId={route.editorOverlayId} canManage={canManage(selectedChannel.role)} {...(route.initialVariable === undefined ? {} : { initialVariable: route.initialVariable })} onBack={() => { navigate({ kind: "channel", channelId: route.channelId, section: "overlays" }); }} />
          : null}
